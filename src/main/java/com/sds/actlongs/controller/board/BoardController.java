...
public class BoardController {
	...
	public ResponseEntity<BoardDetailResponse> getBoardDetail(
		...
		return ResponseEntity.ok(BoardDetailResponse.of(new Video(new Board(new Member("harry", null, null),
			new Channel("Knox SRE", new Member("din", null, null), null, null), "재진스 플레이리스트", "재진스의 뉴진스 플레이리스트 입니다."),
			"static/스크린샷(11)_1686513849288", ImageExtension.PNG, "data/test_1686534272185", VideoExtension.MP4,
	...
	public ResponseEntity<BoardUpdateResponse> updateBoard(@Valid @RequestBody final BoardUpdateRequest request) {
		return ResponseEntity.ok(BoardUpdateResponse.of(new Board(new Member("harry", null, null),
			new Channel("Knox SRE", new Member("din", null, null), null, null), "재진스(수정)",
	...
	public ResponseEntity<BoardListSearchResponse> searchBoardList(
		@NotNull @ApiParam(value = "그룹 ID", example = "1", required = true) @PathVariable("groupId") Long channelId,
		@ApiParam(value = "검색 키워드", example = "재진스", required = true) @Size(max = 50) @RequestParam String keyword) {

		Video video1 = new Video(new Board(new Member("harry", null, null),
			new Channel("Knox SRE", new Member("din", null, null), null, null), "재진스", "재진스의 뉴진스 플레이리스트 입니다."),
			"static/스크린샷(11)_1686513849288", ImageExtension.PNG, "data/test_1686534272185", VideoExtension.MP4,
			Time.valueOf(LocalTime.now()));
		Video video2 = new Video(
			new Board(new Member("ari", null, null), new Channel("Knox SRE", new Member("din", null, null), null, null),
				"재진스2", "재진스2의 뉴진스 플레이리스트 입니다."), "static/스크린샷(11)_1686513849288", ImageExtension.PNG,
			"data/test_1686534272185", VideoExtension.MP4, Time.valueOf(LocalTime.now()));
	...
	public ResponseEntity<BoardListResponse> getBoardList(
		@NotNull @ApiParam(value = "그룹 id", example = "1", required = true) @PathVariable("channelId") Long channelId) {
		Video video1 = new Video(new Board(new Member("harry", null, null),
			new Channel("Knox SRE", new Member("din", null, null), null, null), "재진스", "재진스의 뉴진스 플레이리스트 입니다."),
			"static/스크린샷(11)_1686513849288", ImageExtension.PNG, "data/test_1686534272185", VideoExtension.MP4,
			Time.valueOf(LocalTime.now()));
